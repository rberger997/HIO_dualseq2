...
pathway_heatmap <- function(d1, d2, d3, d4, d5, d6,
  ...
  colnames(paths1)[2:7] <- c(label1,label2,label3,label4,label5,label6)
  
  x <- as.matrix(paths1[2:7])
...
mut <- pathway_heatmap(stm_2h, spi1_2h, spi2_2h,stm_8h, spi1_8h, spi2_8h,
                         'STM 2h', 'SPI1 2h','SPI2 2h', 'STM 8h', 'SPI1 8h', 'SPI2 8h',
                         n = 1357, rows = F, p = 1, cutrows = 4)


# serovars heatmaps
# original heatmap used 80 for ser2h p<0.05
ser <- pathway_heatmap(stm_2h, se_2h, st_2h, stm_8h, se_8h, st_8h,
                         'STM 2h', 'SE 2h','ST 2h', 
                       'STM 8h', 'SE 8h', 'ST 8h',
                       n = 1357, rows = F, p = 1, cutrows = 4)

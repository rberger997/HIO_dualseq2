...
mut_bar_2h <- readRDS(file = here('img/ggplot_objects/gg_mut_reactome_bar_2h.rds'))
mut_bar_8h <- readRDS(file = here('img/ggplot_objects/gg_mut_reactome_bar_8h.rds'))
...
ser_bar_2h <- readRDS(file = here('img/ggplot_objects/gg_ser_reactome_bar_2h.rds'))
ser_bar_8h <- readRDS(file = here('img/ggplot_objects/gg_ser_reactome_bar_8h.rds'))
